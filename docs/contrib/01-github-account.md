...
prev:
  ...
  link: '/contrib/'
next:
  text: '2. Navigating the Repo'
  link: '/contrib/02-navigating-repo'
---

## Creating a GitHub Account

GitHub is a free online platform used for collaborative document editing. All of the Bioland documentation is stored on GitHub, and you can contribute changes directly from your web browser — no software installation required.
...
3. You will be redirected back to GitHub
...
2. Click **Settings**
3. Under **Public profile**, add your name and a profile picture
